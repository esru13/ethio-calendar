                ...
                if (snapshot.connectionState == ConnectionState.waiting)
                  ...
                  return Column(
                    children: <Widget>[
                      Padding(
                        padding:
                            EdgeInsets.all(0.0 * SizeConfig.heightMultiplier),
                        child: Row(
  ...
  Widget _myTime(EtDatetime dt) {
    return Row(
      ...
      children: <Widget>[
        ...
        Text(
          "${_formatHour(dt.hour.toInt() + 6)}:${(dt.minute < 10) ? "0" + dt.minute.toString() : dt.minute}:",
          style: TextStyle(
              fontSize: 2.5 * SizeConfig.textMultiplier,
              fontWeight: FontWeight.w400),
        ),
        Text("${(dt.second < 10) ? "0" + dt.second.toString() : dt.second}",
            style: TextStyle(
                fontSize: 2.5 * SizeConfig.textMultiplier,
